        ...
        if ('root' not in self.scopes) and (not self.is_root) and (len(self.scopes) > 0):
            ...
            if acl != '':
                ...
                for i in range(len(permissions_accquired)):
                    # Iterate though each permissions accquired.
                    # If permission required match any permission accquired
                    # Store corressponding tag_qualifier_accquired to tag_qualifier_valid list
                ...
                # Convert list of tag_qualifier_valid string to list of tag_qualifier valid list
